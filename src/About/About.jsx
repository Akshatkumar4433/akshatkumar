...
function About() {
  return (
    <div className=' h-screen relative w-full'>
        ...
        <div className='max-w-md absolute tablet:left-40 ,desktop:right-80 , right-20, tablet:top-80 desktop:top-80 border-dotted border-4'>
        <img src = {html5Icon} className = 'h-5 w-5' alt = 'html5-icon'/>
        <img src = {css3Icon} className = 'h-5 w-5' alt = 'css3-icon'/>
        <svg className = 'h-5 w-5' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" id="javascript">
          ...
          <img src = {reactIcon} className = 'h-5 w-5' alt = 'react-icon'/>
          <img src = {tailwindIcon} className = 'h-5 w-5' alt = 'tailwind-icon'/>
          <img src = {gitIcon} className = 'h-5 w-5' alt = 'git-icon'/>
